        ...
        <div class="flex items-center space-x-4">
          ...
          >
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19a2 2 0 100-4 2 2 0 000 4z"></path>
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 19a2 2 0 100-4 2 2 0 000 4z"></path>
            </svg>
